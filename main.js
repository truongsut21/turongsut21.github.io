...
setTimeout(function () {
  document.getElementById("cl1").setAttribute("class", "btnClick1");
}, 3000);

function clickStar() {
  alert(
    "Anh có điều này muốn nói với em... thật ra anh thích từ lâu lắm rồi, anh cũng rất muốn trở thành người yêu của em, mãi cố gắng phấn đấu dành cho em điều hp nhất"
  );
...
function khongDongY() {
  ...
  document
    .getElementById("no")
    .setAttribute("style", "margin-top: " + x + "px");
}
function yes() {
  tyLe = tyLe + 10;
